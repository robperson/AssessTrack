...
Discovery Interactive version = 1.0 - EDU | Classroom Resources
Copyright 1997-2008 Omniture, Inc. More info available at
http://www.omniture.com */

var s_account="disccschool";
var s=s_gi(s_account);
/************************** CONFIG SECTION **************************/
var dHost = location.host;
var dPath = location.pathname;
var dirs = dPath.split("/");
var dProt = location.protocol;
var dNet = "EDU";
var strHTML = "";
var lcHREF = location.href.toLowerCase();

s.charSet="ISO-8859-1";
pageName = dHost + dPath;
s.pageName = pageName;
s.server = dHost;
s.pageType = "";
...
//Get Site************************
var site = "";
if ( dHost == "school.discoveryeducation.com" ) {site = "School";}
else if ( dHost == "puzzlemaker.discoveryeducation.com" ) {site = "PuzzleMaker";}
else {site = dHost;}
...
s.prop1 = "EDU";
s.prop2 = "EDU:Classroom Resources";
s.prop3 = "EDU:Classroom Resources:" + site;
s.prop4="";
s.prop5="";
s.prop6="";
s.prop7="EDU:Classroom Resources:" + site;
s.prop8="";
s.prop9="";
s.prop10="";
s.channel="EDU:Classroom Resources";

if (site=="School")
{
	if ( lcHREF.indexOf("/sciencefaircentral") != -1 ) 
	{
	s.prop7="EDU:Classroom Resources:School:Science Fair Central";
	}
	else if ( lcHREF.indexOf("/ontv") != -1 )
	{
	s.prop7="EDU:Classroom Resources:School:On TV";
	}
	else if ( lcHREF.indexOf("/schrockguide") != -1 )
	{
	s.prop7="EDU:Classroom Resources:School:Schrock Guide";
	}
	else if ( lcHREF.indexOf("/clipart") != -1 )
	{
	s.prop7="EDU:Classroom Resources:School:Clip Art";
	}
	else if ( lcHREF.indexOf("/brainboosters") != -1 )
	{
	s.prop7="EDU:Classroom Resources:School:Brain Boosters";
	}
	else if ( lcHREF.indexOf("/teachingtools/worksheetgenerator") != -1 )
	{
	s.prop7="EDU:Classroom Resources:School:Worksheets";
	}
	else if ( lcHREF.indexOf("/curriculumcenter") != -1 )
	{
	s.prop7="EDU:Classroom Resources:School:Curriculum Center";
	}
	else if ( lcHREF.indexOf("/schooladventures") != -1 )
	{
	s.prop7="EDU:Classroom Resources:School:Learning Adventures";
	}
	else if ( lcHREF.indexOf("/homeworkhelp") != -1 ) 
	{
	s.prop7="EDU:Classroom Resources:School:Home Resources";
		if ( lcHREF.indexOf("/math") != -1 ) {s.channel="EDU:Classroom Resources:Math";}
		else if ( lcHREF.indexOf("/science") != -1 ) {s.channel="EDU:Classroom Resources:Science";}
		else if ( lcHREF.indexOf("/english") != -1 ) {s.channel="EDU:Classroom Resources:English";}
		else if ( lcHREF.indexOf("/socialstudies") != -1 ) {s.channel="EDU:Classroom Resources:Social Studies";}
	}
	else if ( lcHREF.indexOf("/lessonplans") != -1 ) 
	{
	s.prop7="EDU:Classroom Resources:School:Lesson Plans";
		if ( lcHREF.indexOf("k-5.html") != -1 ) {s.channel="EDU:Classroom Resources:K-5";}
		else if ( lcHREF.indexOf("6-8.html") != -1 ) {s.channel="EDU:Classroom Resources:6-8gr";}
		else if ( lcHREF.indexOf("9-12.html") != -1 ) {s.channel="EDU:Classroom Resources:9-12gr";}
	}
}


//Site Hierarchy
s.hier1 = "US Nets|Education (Classroom Resources)";
...
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls,m4v,m4a,mp4";
s.linkInternalFilters="javascript:,school.discoveryeducation.com,puzzlemaker.discoveryeducation.com";
...
var startchar=(url.indexOf("campaign")+9);
var querystringend=url.substring(startchar);
if ( querystringend.indexOf("&") != -1 ) {
var sep_pos=(querystringend.indexOf("&")+startchar);
var trackingcode=url.substring(startchar, sep_pos);
}
else {
var trackingcode=url.substring(startchar);
}
...
s.dc=112;
s.trackingServer="img.discovery.com";

//debugging
if ( location.search.indexOf("debug") != -1 )
{
strHTML += "<br />s.pageName = " + s.pageName;
strHTML += "<br />dHost = " + dHost;
strHTML += "<br />dPath = " + dPath;
strHTML += "<br />dProt = " + dProt;
strHTML += "<br />dNet = " + dNet;
strHTML += "<br />s.prop1 = " + s.prop1;
strHTML += "<br />s.prop2 = " + s.prop2;
strHTML += "<br />s.prop3 = " + s.prop3;
strHTML += "<br />s.prop4 = " + s.prop4;
strHTML += "<br />s.prop5 = " + s.prop5;
strHTML += "<br />s.prop6 = " + s.prop6;
strHTML += "<br />s.prop7 = " + s.prop7;
strHTML += "<br />s.prop8 = " + s.prop8;
strHTML += "<br />s.prop9 = " + s.prop9;
strHTML += "<br />s.prop10 = " + s.prop10;
strHTML += "<br />s.eVar1 = " + s.eVar1;
strHTML += "<br />s.campaign = " + s.campaign;
strHTML += "<br />s.channel = " + s.channel;
strHTML += "<br />s.server = " + s.server;
strHTML += "<br />s.pageType = " + s.pageType;
strHTML += "<br />s_account = " + s_account;
strHTML += "<br />s.linkInternalFilters = " + s.linkInternalFilters;
strHTML += "<br />";
}
//end debug
...
/*** writes out variables when ?debug param is included in URL ***/
