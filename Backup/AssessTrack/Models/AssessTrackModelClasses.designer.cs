...
namespace AssessTrack.Models
{
    ...
    partial void OnCourseTermIDChanged();
		...
		[Column(Storage="_QuestionBank", DbType="Bit NOT NULL")]
	...
	[Table(Name="dbo.SubmissionExceptions")]
    ...
    partial void OnCourseTermIDChanged();
		...
		[Column(Storage="_SubmissionExceptionID", AutoSync=AutoSync.OnInsert, DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="Assessment_SubmissionException", Storage="_Assessment", ThisKey="AssessmentID", OtherKey="AssessmentID", IsForeignKey=true)]
		public Assessment Assessment
		{
			get
			{
		...
		[Association(Name="Profile_SubmissionException", Storage="_Profile", ThisKey="StudentID", OtherKey="MembershipID", IsForeignKey=true)]
		public Profile Profile
		{
			get
			{
		...
		[Association(Name="CourseTerm_SubmissionException", Storage="_CourseTerm", ThisKey="CourseTermID", OtherKey="CourseTermID", IsForeignKey=true)]
		public CourseTerm CourseTerm
		{
			get
			{
    ...
    partial void OnMajorChanged();
		...
		[Association(Name="Profile_CourseTermMessage", Storage="_CourseTermMessages", ThisKey="MembershipID", OtherKey="CreatedBy")]
    ...
    partial void OnAccessCodeChanged();
		...
		[Column(Storage="_AccessCode", DbType="VarChar(10)")]
    ...
    partial void OnFstreamChanged();
		...
		[Column(Storage="_Stdin", DbType="Text", UpdateCheck=UpdateCheck.Never)]
		public string Stdin
		{
			get
			{
		...
		[Column(Storage="_Fstream", DbType="Text", UpdateCheck=UpdateCheck.Never)]
	...
	[Table(Name="dbo.CourseTermMessages")]
    ...
    partial void OnCreatedDateChanged();
		...
		[Column(Storage="_MessageID", AutoSync=AutoSync.OnInsert, DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="Profile_CourseTermMessage", Storage="_Profile", ThisKey="CreatedBy", OtherKey="MembershipID", IsForeignKey=true)]
		public Profile Profile
		{
			get
			{
		...
		[Association(Name="CourseTerm_CourseTermMessage", Storage="_CourseTerm", ThisKey="CourseTermID", OtherKey="CourseTermID", IsForeignKey=true)]
		public CourseTerm CourseTerm
		{
			get
			{
    ...
    partial void OnSyllabusChanged();
		...
		[Column(Storage="_CourseTermID", AutoSync=AutoSync.OnInsert, DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		public System.Guid CourseTermID
		{
			get
			{
		...
		[Column(Storage="_Syllabus", DbType="UniqueIdentifier")]
		...
		[Association(Name="CourseTerm_SubmissionException", Storage="_SubmissionExceptions", ThisKey="CourseTermID", OtherKey="CourseTermID")]
		public EntitySet<SubmissionException> SubmissionExceptions
		{
			get
			{
		...
		[Association(Name="CourseTerm_CourseTermMessage", Storage="_CourseTermMessages", ThisKey="CourseTermID", OtherKey="CourseTermID")]
		public EntitySet<CourseTermMessage> CourseTermMessages
		{
			get
			{
		...
		[Association(Name="File_CourseTerm", Storage="_File", ThisKey="Syllabus", OtherKey="FileID", IsForeignKey=true)]
		public File File
		{
			get
			{
    ...
    partial void OnFileIDChanged();
		...
		[Column(Storage="_CourseTermFileID", AutoSync=AutoSync.OnInsert, DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true, IsDbGenerated=true)]
