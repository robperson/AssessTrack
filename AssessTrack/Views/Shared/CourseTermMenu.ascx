...
<ul>
    ...
    <li>
        <%= Html.ATAuthLink("View Tools", new { controller = "CourseTermTools", action = "Index", siteShortName = Html.CurrentSiteShortName(), courseTermShortName = Html.CurrentCourseTermShortName() }, AssessTrack.Filters.AuthScope.CourseTerm, 1, 10)%>
